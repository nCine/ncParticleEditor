...
if(MSVC AND PACKAGE_CRASHRPT AND CMAKE_BUILD_TYPE MATCHES "Debug")
	...
	target_compile_options(${PACKAGE_EXE_NAME} PRIVATE "/Oy-")
	...
	target_include_directories(${PACKAGE_EXE_NAME} PRIVATE ${CRASHRPT_INCLUDE_DIR})
	target_link_libraries(${PACKAGE_EXE_NAME} ${CRASHRPT_LIBRARY})
